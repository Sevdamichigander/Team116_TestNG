...
public abstract class TestBaseRapor {
    ...
    @BeforeTest(alwaysRun = true) // alwaysRun : her zaman çalıştır.Testbase e extends edilen tum dosyalar calistirilmadan once calisir.
    ...
    public void setUpTest() {
        ...
        // user.dir ==> icinde oldugumuz dosyanin yolunu verir
        ...
        extentHtmlReporter.config().setDocumentTitle("Sevda nin raporu");
